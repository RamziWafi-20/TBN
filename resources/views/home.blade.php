...
<head>
    ...
    <link rel="preload" as="image" href="{{ asset('assets/hero-tbn-DTHbnet-.jpg') }}" />
    <link rel="stylesheet" href="{{ asset('assets/styles-Be6PXbW8.css') }}" data-precedence="default" />
    ...
    <link rel="modulepreload" href="{{ asset('assets/index-DhrqBnDf.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/jsx-runtime-BMhk9OTh.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/routes-CbptzsOX.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/button-CcC8dtDH.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/bot-C8MgQXIe.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/coins-CPVBr_xV.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/leaf-D5k7gyuA.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/recycle-BuBPdW-I.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/scan-line-DjekUQRW.js') }}" />
...
<body>
    ...
    <main class="min-h-screen bg-background">
        ...
        <header class="mx-auto flex max-w-6xl items-center justify-between px-5 py-5">
            ...
            <a href="{{ url('/auth') }}" class="inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-primary text-primary-foreground shadow hover:bg-primary/90 h-8 rounded-md px-3 text-xs">Masuk</a>
        </header>
            ...
            <div class="mx-auto grid max-w-6xl items-center gap-10 px-5 pt-8 pb-16 md:grid-cols-2 md:pt-16">
                <div>
                    ...
                    <div class="mt-7 flex flex-wrap gap-3">
                        <a href="{{ url('/auth') }}" class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-primary text-primary-foreground shadow hover:bg-primary/90 h-10 rounded-md px-8">
                            Mulai sekarang 
                ...
                <div class="overflow-hidden rounded-3xl shadow-lift">
                    <img src="{{ asset('assets/hero-tbn-DTHbnet-.jpg') }}" alt="Pelajar memilah sampah daur ulang di halaman sekolah" width="1600" height="1000" class="h-full w-full object-cover" />
                </div>
            </div>
        </section>
    ...
    <script type="module" async="" src="{{ asset('assets/index-DhrqBnDf.js') }}"></script>
</body>
