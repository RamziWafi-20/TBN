...
<p>Untuk mode lokal TBN, email tidak digunakan. Gunakan <strong>OTP dummy</strong> di bawah ini untuk mengaktifkan akun <span class="email"><?php echo e($user->email); ?></span>.</p>
<?php if(session('success')): ?><div class="alert success"><?php echo e(session('success')); ?></div><?php endif; ?>
<?php if(session('info')): ?><div class="alert success"><?php echo e(session('info')); ?></div><?php endif; ?>
<?php if($errors->any()): ?><div class="alert error"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><div><?php echo e($error); ?></div><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div><?php endif; ?>
<div class="otp-box">
...
<form method="POST" action="<?php echo e(route('verification.code.submit')); ?>">
<?php echo csrf_field(); ?>
...
<?php /**PATH D:\xampp-portable-windows-x64-8.2.12-0-VS16\xampp\TBN\TBN Laravel\resources\views/auth/verify-code.blade.php ENDPATH**/ ?>