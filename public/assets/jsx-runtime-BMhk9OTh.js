    ...
    u = o(((e, t) => {
        (function() {
            ...
            function i(e, t) {
                ...
                var n = e + `.` + t;
                H[n] || (console.error("Can't call %s on a component that is not yet mounted. This is a no-op, but it might indicate a bug in your application. Instead, assign to `this.state` directly or define a `state = {};` class property with the desired state in the %s component.", t, e), H[n] = !0)
            }

            function a(e, t, n) {
                this.props = e, this.context = t, this.refs = G, this.updater = n || U
            }
            ...
            function u(e) {
                ...
                if (t) {
                    t = console;
                    var n = t.error,
                        r = typeof Symbol == `function` && Symbol.toStringTag && e[Symbol.toStringTag] || e.constructor.name || `Object`;
            ...
            function y(e) {
                b(e) ? e._store && (e._store.validated = 1) : typeof e == `object` && e && e.$$typeof === V && (e._payload.status === `fulfilled` ? b(e._payload.value) && e._payload.value._store && (e._payload.value._store.validated = 1) : e._store && (e._store.validated = 1))
            }
                    ...
                    case `object`:
                        switch (e.$$typeof) {
                            ...
                            case P:
                                ...
                                break;
                            case V:
                                return s = e._init, C(s(e._payload), t, n, i, a)
                        }
                }
                if (s) {
                    s = e, a = a(s);
                    var c = i === `` ? `.` + x(s, 0) : i;
                    return se(a) ? (n = ``, c != null && (n = c.replace(ge, `$&/`) + `/`), C(a, t, n, ``, function(e) {
                        return e
                    })) : a != null && (b(a) && (a.key != null && (s && s.key === a.key || u(a.key)), n = ee(a, n + (a.key == null || s && s.key === a.key ? `` : (`` + a.key).replace(ge, `$&/`) + `/`) + c), i !== `` && s != null && b(s) && s.key == null && s._store && !s._store.validated && (n._store.validated = 2), a = n), t.push(a)), 1
                }
                if (s = 0, c = i === `` ? `.` : i + `:`, se(e))
                    for (var l = 0; l < e.length; l++) i = e[l], o = c + x(i, l), s += C(i, t, n, o, a);
                else if (l = r(e), typeof l == `function`)
                    for (l === e.entries && (he || console.warn(`Using Maps as children is not supported. Use an array of keyed ReactElements instead.`), he = !0), e = l.call(e), l = 0; !(i = e.next()).done;) i = i.value, o = c + x(i, l++), s += C(i, t, n, o, a);
                else if (o === `object`) {
...
See https://react.dev/link/invalid-hook-call for tips about how to debug and fix this problem.`), e
            ...
            o.prototype = a.prototype, K = s.prototype = new o, K.constructor = s, W(K, a.prototype), K.isPureReactComponent = !0;
            var se = Array.isArray,
                ...
                le = console.createTask ? console.createTask : function() {
                    return null
                };
            K = {
            ...
            var ue, de, fe = {},
                pe = K.react_stack_bottom_frame.bind(K, m)(),
                me = le(f(m)),
                he = !1,
                ge = /\/+/g,
                _e = typeof reportError == `function` ? reportError : function(e) {
                ...
                Z = !1,
                Q = !1,
                ye = typeof queueMicrotask == `function` ? function(e) {
            ...
            e.Activity = ae, e.Children = $, e.Component = a, e.Fragment = F, e.Profiler = ne, e.PureComponent = s, e.StrictMode = I, e.Suspense = z, e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = q, e.__COMPILER_RUNTIME = K, e.act = function(e) {
                var t = q.actQueue,
                    n = X;
                X++;
                var r = q.actQueue = t === null ? [] : t,
                    i = !1;
                try {
                    var a = e()
                } catch (e) {
                ...
                var s = a;
                if (A(t, n), n === 0 && (M(r), r.length !== 0 && ye(function() {
                ...
                var i = null;
                if (t != null)
                    for (c in de || !(`__self` in t) || `key` in t || (de = !0, console.warn(`Your app (or one of its dependencies) is using an outdated JSX transform. Update to the modern JSX transform for faster performance: https://react.dev/link/new-jsx-transform`)), h(t) && (u(t.key), i = `` + t.key), t) J.call(t, c) && c !== `key` && c !== `__self` && c !== `__source` && (r[c] = t[c]);
                ...
                return e._ioInfo = n, t._debugInfo = [{
                    awaited: n
                }], t
            }, e.memo = function(e, t) {
                ...
                var t = q.T,
                    n = {};
                n._updatedFibers = new Set, q.T = n;
                try {
                    var r = e(),
                        i = q.S;
                    i !== null && i(n, r), typeof r == `object` && r && typeof r.then == `function` && (q.asyncTransitions++, r.then(D, D), r.then(c, _e))
                } catch (e) {
                    _e(e)
                } finally {
        ...
        (function() {
            ...
            function r(e) {
                ...
                if (t) {
                    t = console;
                    var r = t.error,
                        i = typeof Symbol == `function` && Symbol.toStringTag && e[Symbol.toStringTag] || e.constructor.name || `Object`;
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`, o, f, m, f), I[f + o] = !0)
            ...
            var h = d(),
                ...
                A = Array.isArray,
                j = console.createTask ? console.createTask : function() {
                    return null
                };
            h = {
                react_stack_bottom_frame: function(e) {
...
export {
    s as a, o as i, p as n, l as o, d as r, h as t
};